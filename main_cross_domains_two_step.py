...
def main():
    ...
    config.update({'num_runs':1, 'save':True, 'tensorboard':False,'tsne':False,'tensorboard_epoch':False,'k_disc':100, 'k_clf':1,'iterations':2})
...
if __name__ == '__main__':
  select_method= 'T_AE' #'T_AE': target auto encoder+discrim; 'T_DA': target discrim; 'ATL_NCE': nce loss (bug exists when adapt to CNN)
...
#              'FD004_FD003': {'epochs':20,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_nce':0.001}}
  hyper_param={'FD001_FD002': {'epochs':200,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},
              'FD001_FD003': {'epochs':250,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},
              'FD001_FD004': {'epochs':80,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1}, #80
              'FD002_FD001': {'epochs':40,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},#40
              'FD002_FD003': {'epochs':140,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},
              'FD002_FD004': {'epochs':100,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},  #100
              'FD003_FD001': {'epochs':140,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},  
              'FD003_FD002': {'epochs':200,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},
              'FD003_FD004': {'epochs':250,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1}, #250
              'FD004_FD001': {'epochs':200,'batch_size':256,'lr':3e-4,'d_lr':3e-4, 'alpha_dtw':1},
              'FD004_FD002': {'epochs':300,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1}, #300
              'FD004_FD003': {'epochs':20,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1}}
  hyper_param2={'FD001_FD002': {'epochs':1,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1}, #0.1
              'FD001_FD003': {'epochs':5,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},
              'FD001_FD004': {'epochs':1,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},
              'FD002_FD001': {'epochs':1,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},
              'FD002_FD003': {'epochs':40,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},#40
              'FD002_FD004': {'epochs':50,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},  #50
              'FD003_FD001': {'epochs':4,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},  
              'FD003_FD002': {'epochs':35,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1}, #35
              'FD003_FD004': {'epochs':5,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},
              'FD004_FD001': {'epochs':50,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1},#1
              'FD004_FD002': {'epochs':100,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1}, #100
              'FD004_FD003': {'epochs':50,'batch_size':256,'lr':5e-5,'d_lr':5e-5, 'alpha_dtw':1}}#5
  # load dataset
  data_path= "./data/processed_data/cmapps_train_test_cross_domain.pt"
  my_dataset = torch.load(data_path)
  ...
  config.update({'num_runs':1, 'save':True, 'tensorboard':False,'tsne':False,'tensorboard_epoch':False,'k_disc':100, 'k_clf':1,'iterations':1, 'permute':False, 'gamma':0.1, 'n_cluster':3, 'alpha_dtw':0.1}) #100
  print(config)
      ...
      for tgt_id in ['FD001', 'FD002', 'FD003', 'FD004']: #'FD001', 'FD002', 'FD003', 'FD004'
          if src_id != tgt_id:
              ...
              for run_id in range(config['num_runs']):
                  ...
                  method_2nd = importlib.import_module(f'trainer.cross_domain_models.CT_AE_sub2')  #CT_AE_sub2
                  src_only_loss, src_only_score, test_loss, test_score, src_tgt_kl_loss, best_tgt_kl_loss, best_tgt_kl_loss2 = method_2nd.cross_domain_train(hyper_param2,device,config,LSTM_RUL,my_dataset,src_id,tgt_id,run_id)
  ...
  print('=' * 89)
  print(df.to_string())
  df.to_csv(f'./results/Final_results_{select_method}_{config["gamma"]}_{config["n_cluster"]}_{config["alpha_dtw"]}_src4.csv')
